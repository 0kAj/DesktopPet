...
public class StretchingPlatform : FallingPlatform
{
    ...
    public StretchingPlatform(double x, double y, double width, double height, double velocityY) : base(x, y, width, height, velocityY)
    {
        _initialWidth = width;
    }

    public StretchingPlatform(double x, double y, double width, double height, double velocityY, Brush color) : base(x, y, width, height, velocityY, color)
    {
        _initialWidth = width;
    }
